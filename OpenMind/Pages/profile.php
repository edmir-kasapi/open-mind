...
<body>
    ...
    <h1 class="text-center display-4">Welcome to your profile!</h1>  
        ...
        <div class ="row w-100">
            ...
            <div class="col d-flex justify-content-end">
                <form action="./editNameEmail" method="post" class="form-floating w-50 border border-black p-3 rounded-3 mt-4">
            ...
            <div class="col">
                <section class="form-floating w-50 p-3 border border-info rounded-3 mt-4" >
                    ...
                    <div class="row">
                        <div class="col">
                            <img src="Pictures/Uploads/Profile_Pictures/<?php echo $profilePic; ?>" onerror="this.onerror=null; this.src='Pictures/Assets/default_profile.png'" alt="..." class="img-thumbnail" width="155" height="155">
                        </div>
                ...
                <form action="./clearPicture" method="post">
    ...
    <form action="./editPassword" method="post" class="form-floating w-25 mx-auto p-3 border border-warning rounded-3 mt-5">
